...
export class RateLimitLog {
    ...
    static createInstance(sessionPayload: CreateRateLimitSessionPayload): RateLimitLogDocument {
...
export type RateLimitLogModelType = Model<RateLimitLogDocument> & typeof RateLimitLog;
